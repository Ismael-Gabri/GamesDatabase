...
builder.Services.AddDbContext<GamesContext>(opt => opt.UseSqlServer("Server=localhost\\SQLEXPRESS; Encrypt=False; database=GamesDb;User ID=sa;Password=1q2w3e4r@#$"));
